defmodule AmbiantcareWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_ambiantcare_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      AmbiantcareWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule AmbiantcareWeb.PageLive do
        use AmbiantcareWeb, :live_view

        on_mount {AmbiantcareWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{AmbiantcareWeb.UserAuth, :ensure_authenticated}] do
  ...
  def on_mount(:ensure_authenticated, _params, session, socket) do
    ...
    if socket.assigns.current_user do
      ...
      socket =
        ...
        |> Phoenix.LiveView.redirect(to: ~p"/#{locale}/users/log_in")
