defmodule AmbiantcareWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :warning && "bg-yellow-50 text-yellow-900 ring-yellow-500 fill-yellow-900",
  ...
  """
  attr :fill_color, :string, default: "fill-blue-600"

  def spinner(assigns) do
    ~H"""
    <svg
      class={"inline mr-2 w-4 h-4 text-gray-200 animate-spin #{@fill_color}"}
      viewBox="0 0 100 101"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AmbiantcareWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AmbiantcareWeb.Gettext, "errors", msg, opts)
    end
  end
