defmodule Clipboard.AI.HuggingFace.Dedicated.Admin do
  @moduledoc """
  API for managing dedicated Hugging Face endpoints (AI models deployed on a provider's server).
  """

  import Clipboard.AI.HuggingFace.Helpers, only: [headers: 1]
  ...
  defp config do
    :clipboard
    |> Application.fetch_env!(Clipboard.AI.HuggingFace)
