defmodule Clipboard.MedicalNotes.Template do
  use Ecto.Schema
  ...
  def default_template_attrs do
    %{
      key: "0",
      title: Gettext.gettext(ClipboardWeb.Gettext, "Default"),
  ...
  def gastroenterology_template_attrs do
    %{
      key: "1",
      title: Gettext.gettext(ClipboardWeb.Gettext, "Gastroenterology"),
