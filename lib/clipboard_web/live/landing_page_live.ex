defmodule ClipboardWeb.LandingPageLive do
  ...
  def mount(_params, _session, socket) do
    {:ok, socket, layout: {ClipboardWeb.Layouts, :landing_page}}
  end
    ...
    <section class="bg-white dark:bg-gray-900 snap-center" id="how-it-works">
      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center sm:py-16 lg:px-6">
        ...
        <div class="mt-8 lg:mt-12 space-y-8 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
            <.microphone_icon />
            <h3 class="mb-2 text-xl font-bold dark:text-white ">1. Record</h3>
          ...
          <div>
            <.clipboard_icon />
            <h3 class="mb-2 text-xl font-bold dark:text-white">2. Consult</h3>
            <p class="mb-4 text-gray-500 dark:text-gray-400">
              <%= gettext(
          ...
          <div>
            <.approval_check_icon />
            <h3 class="mb-2 text-xl font-bold dark:text-white">3. Generate</h3>
            <p class="mb-4 text-gray-500 dark:text-gray-400">
              <%= gettext(
  ...
  defp clipboard_icon(assigns) do
    ~H"""
    <svg
      class="mx-auto mb-4 w-12 h-12 text-blue-600 dark:text-blue-500"
      fill="currentColor"
