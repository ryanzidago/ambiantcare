defmodule Ambiantcare.Accounts do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> deliver_user_update_email_instructions(user, current_email, &url(~p"/#{locale}/users/settings/confirm_email/#{&1}"))
      {:ok, %{to: ..., body: ...}}
  ...
  ## Examples
      ...
      iex> deliver_user_confirmation_instructions(confirmed_user, &url(~p"/#{locale}/users/confirm/#{&1}"))
  ...
  ## Examples
      ...
      iex> deliver_user_reset_password_instructions(user, &url(~p"/#{locale}/users/reset_password/#{&1}"))
      {:ok, %{to: ..., body: ...}}
